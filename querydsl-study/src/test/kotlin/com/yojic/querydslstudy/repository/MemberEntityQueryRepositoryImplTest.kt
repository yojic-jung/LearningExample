...
//class MemberEntityQueryRepositoryImplTest {
//    @Autowired
...
//        memberJpaRepository.save(MemberDataEntity(memId = 1, email = "dywlr@naver.com"))
//
...
//        memberJpaRepository.save(MemberDataEntity(memId = 2, email = "emailtest@email.com"))
